...
export const MainView: FunctionComponent<Props> = ({ loading, error }) => {
  ...
  return (
    <div className="flex-1 flex h-full flex-col justify-center items-center text-center px-4">
      ...
      {!loading && !error && (
        <div className="text-lg text-gray-800 items-center my-3 ">
          {environmentList.length > 0 ? (
            <>
              <p>
                Click "Connect" on the top menu to connect to one of your saved
                environments.
              </p>
            ...
            <>
              ...
              <p>
                You can create new environments by clicking "Connect" on the top
                menu.
              </p>
            </>
          )}
