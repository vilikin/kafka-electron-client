  ...
  companion object {
    fun parse(string: String): MessageFromClient {
      val runtimeTypeAdapterFactory = RuntimeTypeAdapterFactory
        ...
        .registerSubtype(
          SubscribeToRecordsOfTopic::class.java,
          Type.SUBSCRIBE_TO_RECORDS_OF_TOPIC.name
        )
        .registerSubtype(
          UnsubscribeFromRecordsOfTopic::class.java,
          Type.UNSUBSCRIBE_FROM_RECORDS_OF_TOPIC.name
        )
        .registerSubtype(
          SubscribeToOffsetsOfConsumerGroup::class.java,
          Type.SUBSCRIBE_TO_OFFSETS_OF_CONSUMER_GROUP.name
        )
        .registerSubtype(
          UnsubscribeFromOffsetsOfConsumerGroup::class.java,
          Type.UNSUBSCRIBE_FROM_OFFSETS_OF_CONSUMER_GROUP.name
        )
        .registerSubtype(
          SubscribeToOffsetsOfTopic::class.java,
          Type.SUBSCRIBE_TO_OFFSETS_OF_TOPIC.name
        )
        .registerSubtype(
